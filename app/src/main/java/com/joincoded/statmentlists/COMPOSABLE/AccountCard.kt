package com.joincoded.statmentlists.COMPOSABLE
...
import com.joincoded.statmentlists.data.DataTransaction
...
fun AccountStatmentCard(accountStatement: DataTransaction){
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "${accountStatement.amount} KWD",
                fontSize = 16.sp
            )
            ...
            Text(
                text = "Balance: ${accountStatement.balance} KWD",
                fontSize = 16.sp,
                fontWeight = FontWeight.Bold
            )
        }
